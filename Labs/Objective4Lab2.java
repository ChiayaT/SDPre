...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    int nOutput = num1 + num2 + num3;
    double dOutput = dub1 + dub2 + dub3;

    System.out.println("The sum of " + num1 + " + " + num2 + " + " + num3 + " = " + nOutput);
    System.out.println("The sum of " + dub1 + " + " + dub2 + " + " + dub3 + " = " + dOutput);
